...
class EDD_Extension_Activation {
    ...
    public function __construct( $plugin_path, $plugin_file ) {
        ...
        if( isset( $plugins[$this->plugin_path . '/' . $this->plugin_file]['Name'] ) ) {
            ...
            $this->plugin_name = __( 'EDD Mailchimp Abandoned Cart', 'edd-mailchimp-abandoned-cart' );
        }
    ...
    public function run() {
        // Display notice
        add_action( 'admin_notices', array( $this, 'edd_abd_mailchimp_missing_edd_notice' ) );
    }
     ...
     */
    public function edd_abd_mailchimp_missing_edd_notice() {
        if( $this->has_edd ) {
